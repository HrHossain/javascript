...
<body class="max-w-[1920px] mx-auto">
    <div class="bg-white text-slate-900 text-[15px]">
        <!-- navbar -->
        <header class="sticky top-0 flex shadow-md py-2 px-4 sm:px-10 bg-white min-h-[70px] tracking-wide z-50">
            <div class="flex flex-wrap items-center justify-between gap-5 w-full">
                ...
                <a href="javascript:void(0)" class="hidden max-sm:block"><img
                        src="https://readymadeui.com/readymadeui-short.svg" alt="logo" class="w-9" /></a>

                <div id="collapseMenu"
                    class="max-xl:hidden xl:!block max-xl:before:fixed max-xl:before:bg-black max-xl:before:opacity-50 max-xl:before:inset-0 max-xl:before:z-50">
                    <button id="toggleClose"
                        class="xl:hidden cursor-pointer fixed top-2 right-4 z-[100] rounded-full bg-white w-9 h-9 flex items-center justify-center border">
                    ...
                    <ul
                        class="xl:flex gap-x-5 max-xl:space-y-3 max-xl:fixed max-xl:bg-white max-xl:w-1/2 max-xl:min-w-[300px] max-xl:top-0 max-xl:left-0 max-xl:p-6 max-xl:h-full max-xl:shadow-md max-xl:overflow-auto z-50">
                        <li class="mb-6 hidden max-xl:block">
                            <a href="javascript:void(0)"><img src="https://readymadeui.com/readymadeui.svg" alt="logo"
                                    class="w-36" />
                            </a>
                        </li>
                        <li class="max-xl:border-b max-xl:border-gray-300 max-xl:py-3 px-3">
                            <a href='#features' class="hover:text-blue-700 block font-medium">Features</a>
                        </li>
                        <li class="max-xl:border-b max-xl:border-gray-300 max-xl:py-3 px-3">
                            <a href='#how-it-works' class="hover:text-blue-700 block font-medium">How Works</a>
                        </li>
                        <li class="max-xl:border-b max-xl:border-gray-300 max-xl:py-3 px-3">
                            <a href='#integrations' class="hover:text-blue-700 block font-medium">Integrations</a>
                        </li>
                        <li class="max-xl:border-b max-xl:border-gray-300 max-xl:py-3 px-3">
                            <a href='#pricing' class="hover:text-blue-700 block font-medium">Pricing</a>
                        </li>
                        <li class="max-xl:border-b max-xl:border-gray-300 max-xl:py-3 px-3">
                            <a href='#testimonials' class="hover:text-blue-700 block font-medium">Testimonials</a>
                        </li>
                        <li class="max-xl:border-b max-xl:border-gray-300 max-xl:py-3 px-3">
                            <a href='#faq' class="hover:text-blue-700 block font-medium">Faq</a>
                        </li>
                    </ul>
                </div>

                <div class="flex max-xl:ml-auto gap-4">
                    <button
                        class="px-4 py-2.5 rounded-lg font-medium cursor-pointer tracking-wide text-white border border-blue-600 bg-blue-600 hover:bg-blue-700 transition-all">Get
                        started</button>

                    <button id="toggleOpen" class="xl:hidden cursor-pointer">
                ...
                <div class="grid xl:grid-cols-2 justify-center items-center gap-10">
                    <div>
                        <div class="max-w-3xl max-xl:mx-auto max-xl:text-center">
                            <p class="mb-2 font-semibold text-blue-600"><span
                                    class="rotate-90 inline-block mr-2">|</span> ALL IN ONE MEETING SCHEDULER</p>
            ...
            <div id="features"
                ...
                <div class="container mx-auto">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
                        <div
                            class="bg-white p-8 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all">
            ...
            <div class="py-16 bg-gradient-to-t from-blue-400 via-blue-500 to-blue-600 md:mt-28 mt-16 px-4 sm:px-10">
                <div class="container mx-auto text-center">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4 mt-12">
                        <button
                            class="cursor-pointer bg-white px-6 py-3 rounded-lg hover:bg-gray-100 transition font-medium">Start
